...
func (*TensorDescription) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{0} }
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor_description.proto", fileDescriptor14)
}
